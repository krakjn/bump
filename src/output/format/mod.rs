...
mod tests {
    ...
    fn fixture_fields() -> Fields {
        Fields::populate("", Case::Uppercase, &Version::test_fixture()).unwrap()
    }

    #[test]
    fn render_raw_format_and_spacing() {
        let out = render(Format::Raw, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                "VERSION_PREFIX=\"v-\"\n",
                ...
                "VERSION_PHASE=\"\"\n",
                "VERSION_PHASE_DISTANCE=0\n",
                "VERSION_STRING=\"v-0.1.0\"\n",
                "VERSION_TIMESTAMP=\"2026-01-01 00:00:00 UTC\"",
            )
        );
    }

    #[test]
    fn render_c_format_and_spacing() {
        let out = render(Format::C, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                ...
                "#define VERSION_PHASE_DISTANCE 0\n",
                "#define VERSION_STRING \"v-0.1.0\"\n",
                "#define VERSION_TIMESTAMP \"2026-01-01 00:00:00 UTC\"",
            )
        );
    }

    #[test]
    fn render_c_header_format_and_spacing() {
        let out = render(Format::CHeader, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
    ...
    #[test]
    fn render_go_format_and_spacing() {
        let out = render(Format::Go, &fixture_fields()).unwrap();
        assert!(
            !out.contains('\t'),
            "go emit must use spaces, not tabs:\n{out}"
        );
        assert_eq!(
            out,
            concat!(
    ...
    #[test]
    fn render_java_format_and_spacing() {
        let out = render(Format::Java, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                "/**\n",
                ...
                "    public static final int VERSION_PHASE_DISTANCE = 0;\n",
                "    public static final String VERSION_STRING = \"v-0.1.0\";\n",
                "    public static final String VERSION_TIMESTAMP = \"2026-01-01 00:00:00 UTC\";\n",
                "}\n",
            )
        );
    }
    ...
    #[test]
    fn render_csharp_format_and_spacing() {
        let out = render(Format::CSharp, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                "/**\n",
                ...
                "    public const string VERSION_PHASE = \"\";\n",
                "    public const int VERSION_PHASE_DISTANCE = 0;\n",
                "    public const string VERSION_STRING = \"v-0.1.0\";\n",
                "    public const string VERSION_TIMESTAMP = \"2026-01-01 00:00:00 UTC\";\n",
                "}\n",
            )
        );
    }
    ...
    #[test]
    fn render_python_format_and_spacing() {
        let out = render(Format::Python, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                "# This file is generated by:\n",
    ...
    #[test]
    fn render_json_format_and_spacing() {
        let out = render(Format::Json, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                "{\n",
    ...
    #[test]
    fn render_toml_format_and_spacing() {
        let out = render(Format::Toml, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                "[version]\n",
    ...
    #[test]
    fn render_yaml_format_and_spacing() {
        let out = render(Format::Yaml, &fixture_fields()).unwrap();
        assert_eq!(
            out,
            concat!(
                "version:\n",
